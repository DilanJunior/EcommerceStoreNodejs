...
<div className="flex flex-col md:flex-row md:justify-around items-center md:mt-6">

        


        
<div className="ad-banner z-0 w-full md:w-3/6  mb-4 rounded-lg">
...
<div className=" p-4 w-full md:h-full md:w-4/12">
  <div>
    <h1 className="text-white text-3xl">Bienvenido a Bisutería Jacky</h1>
